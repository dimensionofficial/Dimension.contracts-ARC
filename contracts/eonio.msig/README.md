...
````
$ cleon multisig propose test '[{"actor": "treasury", "permission": "active"}]' '[{"actor": "treasury", "permission": "active"}]' eonio.token issue '{"to": "tester", "quantity": "1000.0000 EON", "memo": ""}' -p tester
